...
| **Contexto de entrada** | Sin información previa del stack ni procesos internos |
...
## Entregables a Preparar Antes del 8 de Junio

| Entregable | Estado | Descripción |
|------------|--------|-------------|
| Estrategia QA completa | En este doc | Enfoque, herramientas y procesos propuestos |
| Plan primeros 30 días | En este doc | Semana a semana con objetivos claros |
| Templates listos | Pendiente | Casos de prueba, bug reports y SDD |
| Pipeline CI/CD | Pendiente | Pipeline funcional con Cypress en GitHub Actions |
| Presentación ejecutiva | Pendiente | Slides para presentar propuesta QA al equipo/jefe |

---

## Stack Personal (nivel intermedio en todas)

| Herramienta | Nivel | Uso previsto en BUPA |
|-------------|-------|----------------------|
| Cypress | Intermedio | Automatización E2E del portal de pacientes |
| Jira | Intermedio | Gestión de bugs, trazabilidad, reportes de sprint |
| GitHub Actions | Intermedio | Pipeline CI/CD con quality gates |
| n8n | Intermedio | Automatización de reportes y notificaciones QA |

---

## Estrategia QA — Propuesta Inicial

> Documento para presentar en los primeros días. Ajustar según lo que se descubra el día 8.

### Pilares de la estrategia

1. **Observar antes de proponer** — primera semana dedicada a entender procesos actuales, stack real y equipo
2. **Testing manual estructurado** — casos de prueba documentados con criterios de aceptación claros
3. **Automatización progresiva** — comenzar con los flujos más críticos (login, carga del portal)
4. **Trazabilidad completa** — cada bug vinculado a un requerimiento y a un caso de prueba
5. **Reporte continuo** — métricas semanales visibles para el equipo y stakeholders

### Servicios concretos a ofrecer

- Definición de Definition of Done con criterios de calidad
- Documentación de requerimientos con criterios de aceptación
- Casos de prueba manuales y automatizados
- Pipeline CI/CD con Cypress integrado
- Reportes semanales de cobertura y estado de bugs
- Gestión de defectos en Jira con trazabilidad
- Testing de accesibilidad (WCAG) para el portal de pacientes

---

## Plan Primeros 30 Días
...
### Semana 2 — Documentar y proponer (16–20 junio)
- [ ] Levantar los requerimientos funcionales principales
- [ ] Documentar casos de prueba manuales para flujos críticos
- [ ] Presentar propuesta de estrategia QA al equipo
- [ ] Definir Definition of Done con el equipo

### Semana 3 — Ejecutar y evidenciar (23–27 junio)
- [ ] Ejecutar primera ronda de pruebas manuales
- [ ] Registrar bugs encontrados en Jira con trazabilidad
- [ ] Iniciar configuración del pipeline CI/CD con Cypress
- [ ] Primer reporte semanal de QA entregado

### Semana 4 — Automatizar y consolidar (30 junio–4 julio)
- [ ] Primer spec de Cypress automatizado (flujo crítico)
- [ ] Pipeline corriendo en GitHub Actions
- [ ] Retrospectiva del mes: qué funcionó, qué mejorar
- [ ] Propuesta de roadmap QA para el siguiente mes
